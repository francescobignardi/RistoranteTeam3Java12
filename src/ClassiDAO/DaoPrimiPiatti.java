...
public class DaoPrimiPiatti {
    ...
    public void insert(PrimiPiatti primiPiatti, String nomeTabella) {
        ...
        try {
            ...
            String insertQuery = "INSERT INTO " + nomeTabella +
                    " (name, price, isOutMenu, isIntegral, isGlutenFree) VALUES ('" +
                    primiPiatti.getName() + "', " + primiPiatti.getPrice() + ", " + primiPiatti.isOutMenu() + ", " +
                    primiPiatti.isIntegral() + ", " + primiPiatti.isGlutenFree() + ");";
    ...
    public void updateTable(PrimiPiatti primiPiatti, int id, String nomeTabella) {
        try {
            Connection conn = DriverManager.getConnection(URL, USER, PASS);
            Statement statement = conn.createStatement();

            String updateQuery = "UPDATE " + nomeTabella +
                    " SET name='" + primiPiatti.getName() +
                    " ',price= " + primiPiatti.getPrice() +
                    ", isOutMenu= " + primiPiatti.isOutMenu() +
                    ", isIntegral= " + primiPiatti.isIntegral() +
                    ", isGlutenFree= " + primiPiatti.isGlutenFree() +
                    " WHERE id=" + id + ";";
